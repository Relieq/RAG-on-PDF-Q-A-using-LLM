...
Khi chạy trên colab, các bạn hãy lưu ý upload file app.py mà tôi đã tạo sẵn trong
repository này (về cơ bản là chứa các đoạn code từ phần 2.2 đến hiện tại) để có thể
triển khai ứng dụng trên web bằng chainlit. Sau đó các bạn chạy tiếp lệnh sau trên
colab:
